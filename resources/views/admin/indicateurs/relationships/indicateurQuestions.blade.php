...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-indicateurQuestions">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.question.fields.indicateur') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($questions as $key => $question)
                        <tr data-entry-id="{{ $question->id }}">
                            ...
                            <td>
                                {{ App\Models\Question::RECURRENCE_RADIO[$question->recurrence] ?? '' }}
                            </td>
                            <td>
                                {{ $question->indicateur->description ?? '' }}
                            </td>
                            <td>
                                @can('question_show')
...
@endcan
  ...
  let table = $('.datatable-indicateurQuestions:not(.ajaxTable)').DataTable({ buttons: dtButtons })
